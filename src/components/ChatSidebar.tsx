...
export function ChatSidebar() {
  ...
  const handleNewChat = () => {
    ...
    logger.info('Created new conversation from sidebar:', newConversation.id);
  ...
  const handleSelectConversation = (conversation: Conversation) => {
    if (conversation.id !== currentConversationId) {
      ...
      logger.debug('Selected conversation from sidebar:', conversation.id);
    }
  };
  ...
  const handleDeleteConversation = (id: string) => {
    ...
    logger.info('Deleted conversation:', id, 'new current:', newCurrentId);
